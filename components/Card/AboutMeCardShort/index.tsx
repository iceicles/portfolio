...
const AboutMeCardShort: FC<AboutMeCardShort> = ({
  ...
  return (
    <>
      <button
        onClick={() => onClick(id)}
        className='max-lg:border-button p-2 rounded-xl shadow-2xl shadow-blue-500/30 md:hover:border-button hover:animate-pulse2 border border-solid lg:border-none'
      >
